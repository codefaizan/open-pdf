...
TESSDATA_DIR = PACKAGE_ROOT / "tessdata"
RENDER_SCALE = 2
...
def bundled_tessdata_available() -> bool:
    return (TESSDATA_DIR / "eng.traineddata").is_file()
...
def configure_tesseract() -> None:
    if not bundled_tessdata_available():
        raise RuntimeError(
            f"Bundled OCR models are missing from {TESSDATA_DIR}. "
